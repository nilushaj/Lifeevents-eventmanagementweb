<?php
session_start();
include_once('functionsvideo.php');
?>
<!DOCTYPE html>
                ...
                <div class="blog">
                    <div class="blog-item">
                        ...
                        <div class="blog-content">
                            ...
                            <h3>Excellent in Videography</h3>
                            <p>
                                <?php
                                echo $sdetails;
                                ?>
                            ...
                            <?php
$sql = "SELECT * FROM comments where servid='serv2' ";
...
;
                                if($uid=='guest'){
                                    ...
                                    <form class="form-horizontal" role="form" action="Videography.php" method="post">
                                    ...
                                    if (isset($_POST['submitted'])){
                                        ...
                                        $rowcount=$rowcount+1;
                                        $date=date("Y-m-d");
                                        $query = "INSERT into comments (username,comment,cmntdate,servid) values('$uid','$uc','$date','serv2')";

                                        if (mysqli_query($connect,$query)) {
                                            echo  '<script> location.replace("Videography.php"); </script>';
                                        } else {
