<?php
session_start();
include_once('functionshike.php');
                ...
                <div class="blog">
                    <div class="blog-item">
                        ...
                        <div class="blog-content">
                            ...
                            <?php
$sql = "SELECT * FROM comments where servid='serv3'";
...
;
                                if($uid=='guest'){
                                    ...
                                    <form class="form-horizontal" role="form" action="Adventure.php" method="post">
                                    ...
                                    if (isset($_POST['submitted'])){
                                        ...
                                        $rowcount=$rowcount+1;
                                        $date=date("Y-m-d");
                                        $query = "INSERT into comments (username,comment,cmntdate,servid) values('$uid','$uc','$date','serv3')";
                                        if (mysqli_query($connect,$query)) {
                                            echo  '<script> location.replace("Adventure.php"); </script>';
                                        } else {
...
<section id="bottom" class="wet-asphalt">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                <h4>Our Location</h4>
                <iframe style="border-radius: 10px;" width="100%" height="215" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d860.0361355067042!2d80.70172630840645!3d7.320941389421717!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zN8KwMTknMTUuNCJOIDgwwrA0MicwOC4zIkU!5e1!3m2!1sen!2slk!4v1510648366706"></iframe>            </div>
            </div>
        </div>
    </div>
</section><!--/#bottom-->
