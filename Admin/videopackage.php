...
<section id="title" class="emerald">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <h1>Videography Package Details</h1>
            ...
            <div class="col-sm-6">
                <ul class="breadcrumb pull-right">
                    <li><a href="index.php">Home</a></li>
                    <li ><a href="PackageDetails.php">Package Details</a></li>
                    <li class="active">Videography</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <table class="table table-bordered">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <tr>
                            ...
                            <td><a href="deletevideopckage.php?id=<?php echo $row['package_name']; ?>" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="insert_form">
                    ...
                    <label>Enter No of Cameras</label>
                    <input type="text" value="0" name="camera" id="camera" class="form-control"/>
                    <br/>
        ...
        $(document).on('click', '.edit_data', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#hours').val(data.no_of_hours);
                    $('#camera').val(data.no_of_cameras);
                    $('#dvd').val(data.soft_copy);
                    $('#movie').val(data.after_movie);

                    $('#stream').val(data.live_stream);
