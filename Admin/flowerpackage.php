                ...
                <table class="table table-bordered">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <tr>
                            ...
                            <td><a href="deleteflowerpackage.php?id=<?php echo $row['package_name']; ?>" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="insert_form">
                    ...
                    <br/>
                    <label>Enter Type of Flower</label>
                    <input type="text" value="0" name="type" id="type" class="form-control"/>
                    <br/>

                    <label>Enter Name of Flower</label>
                    <input type="text" value="0" name="flowern" id="flowern" class="form-control"/>
                    <label>Enter No of Table</label>
                    <input type="text" value="0" name="table" id="table" class="form-control"/>
        ...
        $(document).on('click', '.edit_data', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#type').val(data.type_of_flower);
                    $('#flowern').val(data.name_of_flower);
                    $('#table').val(data.no_of_table);
