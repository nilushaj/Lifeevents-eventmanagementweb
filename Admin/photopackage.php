...
<section id="title" class="emerald">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <h1>Photography Package Details</h1>
                ...
                <table class="table table-bordered">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <tr>
                            ...
                            <td><a href="deletephotopckage.php?id=<?php echo $row['package_name']; ?>" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="insert_form">
                    ...
                    <label>Enter No of Photographers</label>
                    <input type="text" value="0" name="photographers" id="photographers" class="form-control"/>
                    <br/>
                    <label>Enter No of Hours</label>
                    <input type="text" value="0" name="hours" id="hours" class="form-control"/>
                    <br/>

                    <label>Enter No of Photos</label>
                    <input type="text" value="0" name="photos" id="photos" class="form-control"/>
                    <br/>
                    <label>Story Book</label>
                    <select name="story" id="story" class="form-control">
                        <option value="No">No</option>
                        <option value="Yes">Yes</option>
                    </select>
                    <br/>
                    <label>Pre Shoot</label>
                    <select name="preshoot" id="preshoot" class="form-control">
                        <option value="No">No</option>
                        <option value="Yes">Yes</option>
                    </select>
                    <br/>
                    <label>Soft Copy DVD</label>
                    <select name="dvd" id="dvd" class="form-control">
                        <option value="No">No</option>
                        <option value="Yes">Yes</option>
                    </select>
                    <br/>
        ...
        $(document).on('click', '.edit_data', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#photographers').val(data.noofphotographers);
                    $('#hours').val(data.hours);
                    $('#photos').val(data.noofphotos);
                    $('#story').val(data.storybook);
                    $('#preshoot').val(data.preshoot);

                    $('#dvd').val(data.softcopydvd);
