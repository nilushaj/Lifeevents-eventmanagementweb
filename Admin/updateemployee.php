...
<section id="title" class="emerald">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <?php
                $sqlu = 'Select * from employees where employee_id="' . $_GET['id'] . '"';
                $sthu = $connect->query($sqlu);
                $resultu = mysqli_fetch_assoc($sthu);


                ?>
                <h1>Edit <?php echo $resultu['employee_name']; ?></h1>
...
<section id="registration" class="container">
    ...
    <legend align="center">Edit <?php echo $resultu['employee_name']; ?></legend>
    <form id=registration_form action="" method="post" action="updateemployee.php" method="post"
          enctype="multipart/form-data">
        <div class="form-group">
            <label><span>Employee Name: </span></label>
            <input type="text" style="width: 30%" id="employeename" name="employeename" placeholder="Employee Name"
                   value="<?php echo $resultu['employee_name']; ?>" class="form_text">
            <span class="error_form" id="username_error_message"></span>
        </div>
        <div class="form-group">
            <label><span>Title: </span></label>
            <select class="form-text" id="title" name="title">
                <option value="<?php echo $resultu['title']; ?>"><?php echo $resultu['title']; ?></option>
        ...
        <div class="form-group">
            ...
            <textarea rows="7" style="width: 30%;" id="qualification" name="qualification" class="form-control" placeholder="Descrition"><?php echo $resultu['qualification']; ?></textarea>
        </div>
        <div class="form-group">
            <label><span>E-mail: </span></label>
            <input type="text" style="width: 30%" value="<?php echo $resultu['email']; ?>" id="email" name="email"
                   placeholder="E Mail" class="form_text"><span
                    class="error_form" id="email_error_message"></span>
        </div>
        <div class="form-group">
            <label><span>Mobile: </span></label>
            <input type="text" value="<?php echo $resultu['mobile']; ?>" id="mobile" name="mobile" placeholder="Mobile"
                   class="form_text">
        </div>
        <div class="form-group">
            <label><span>Address: </span></label>
            <input style="width: 30%" value="<?php echo $resultu['address']; ?>" type="text" id="address" name="address"
                   placeholder="Address" class="form_text">
        </div>
...
employee_name='$ename',title='$title',qualification='$qualification',
email='$email',mobile='$mob',address='$address',photo_id='$file' where employee_id='" . $_GET['id'] . "'";
