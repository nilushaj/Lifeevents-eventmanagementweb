...
<section id="title" class="emerald">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <h1>DJ Music Package Details</h1>
                ...
                <table class="table table-bordered">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <tr>
                            ...
                            <td><a href="deletedjpackage.php?id=<?php echo $row['package_name']; ?>" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="insert_form">
                    ...
                    <input type="text" value="0" name="venue" id="venue" class="form-control"/>
                    <br/>

                    <label>Enter No of playing Hours</label>
