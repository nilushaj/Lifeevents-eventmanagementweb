<?php
session_start();
 include_once('functionsphoto.php');
                ...
                <div class="blog">
                    <div class="blog-item">
                        ...
                        <div class="blog-content">
                            ...
                            <h3>Excellent in Photography</h3>
                            <p>
                                <?php
                                echo $sdetails;
                                ?>
                            ...
                            <?php
$sql = "SELECT * FROM comments where servid='serv1' ";
...
;
                                if($uid=='guest'){
                                    ...
                                    <form class="form-horizontal" role="form" action="Photography.php" method="post">
                                    ...
                                    if (isset($_POST['submitted'])){
                                        ...
                                        $rowcount=$rowcount+1;
                                        $date=date("Y-m-d");
                                        $query = "INSERT into comments (username,comment,cmntdate,servid) values('$uid','$uc','$date','serv1')";
                                        if (mysqli_query($connect,$query)) {
                                            echo  '<script> location.replace("Photography.php"); </script>';
                                        } else {
