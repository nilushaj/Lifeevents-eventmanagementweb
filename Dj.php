                ...
                <div class="blog">
                    <div class="blog-item">
                        ...
                        <div class="blog-content">
                            ...
                            <?php
$sql = "SELECT * FROM comments where servid='serv4' ";
...
;
                                if($uid=='guest'){
                                    ...
                                    <form class="form-horizontal" role="form" action="Dj.php" method="post">
                                    ...
                                    if (isset($_POST['submitted'])){
                                        ...
                                        $rowcount=$rowcount+1;
                                        $date=date("Y-m-d");
                                        $query = "INSERT into comments (username,comment,cmntdate,servid) values('$uid','$uc','$date','serv4')";
                                        if (mysqli_query($connect,$query)) {
                                            echo  '<script> location.replace("Dj.php"); </script>';
                                        } else {
