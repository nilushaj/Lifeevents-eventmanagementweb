...
<header class="navbar navbar-inverse navbar-fixed-top wet-asphalt" role="banner">
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="about-us.php">About Us</a></li> <li><a href="bookinglog.php">Online Booking</a></li>
    ...
    <section id="registration" class="container">
        ...
        $sthu = $connect->query($sqlu);
        $resultu = mysqli_fetch_assoc($sthu);
        $spassword = $resultu['password'];

        ?>

        <legend align="center">Update</legend>
        <form id=registration_form method="post" action="Update.php" method="post" enctype="multipart/form-data">
            <table>
                <tr>
                    <td><label><span>Username: </span></label></td>
                    <td>  <input type="text" id="username" name="username" placeholder="Username" value="<?php echo $_SESSION['username']; ?>" class="form_text" readonly></td>
                    <td><span class="error_form" id="username_error_message"></span></td>
                </tr>
                <tr>
                    <td><label><span>First_Name </span></label></td>
                    <td>  <input type="text" value="<?php echo $resultu['firstname']?>" id="firstname" name="firstname" class="form_text"></td>
                    <td><span class="error_form" id="first_error_message"></span></td>
                </tr>
                <tr>
                    <td><label><span>Last_Name </span></label></td>
                    <td>  <input type="text" id="lastname" value="<?php echo $resultu['lastname']?>" name="lastname"  class="form_text"></td>
                    <td><span class="error_form" id="last_error_message"></span></td>
                </tr>
                <tr>
                    <td><label><span>Email: </span></label></td><td><input type="text" id="email" name="email" value="<?php echo $resultu['email']; ?>" class="form_text" placeholder="E-mail" >
                      </td>
                    <td><span class="error_form " id="email_error_message"></span></td>
                </tr>
                <tr>
                    <td><label><span>Old_Password: </span></label></td>
                    <td><input type="password" id="oldpassword" name="oldpassword"  class="form_text" placeholder="Old Password" ></td>
                    <td><span class="error_form" id="oldpassword_error_message"></span></td>
                    <script type="text/javascript">var oldpass=<?php echo $spassword; ?></script>

                </tr>
                <tr>
                    <td><label><span>New_Password: </span></label></td>
                    <td><input type="password" id="password" name="password"  class="form_text" placeholder="New Password" ></td>
                ...
                <tr>
                    <td><label><span>Mobile: </span></label></td>
                    <td> <input type="text" value="<?php echo $resultu['Mobile']; ?>" id="mobile" class="form_text" name="mobile" placeholder="mobile" />
                    </td>
                    <td></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td></td>
                    <td> <button class="smart-green button" type="submit" name="submit" id="submit">Save</button></td>
                    <td></td>
                </tr>
            </table>
            <?php
            if (isset($_POST['submit'])){
                ...
                $query="UPDATE user SET firstname='$fname', lastname='$lname' ,email='".$usemail."',password='".$password."',Mobile='".$mob."',imageid='".$file."' WHERE username='".$uid."'";
                if(mysqli_query($connect, $query))
                {
                    ...
                    echo '<script>alert("Error!!Email is Existing")</script>';
                }
